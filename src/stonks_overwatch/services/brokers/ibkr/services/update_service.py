            ...
            try:
                self._retry_database_operation(
                    ...
                    defaults={
                        ...
                        "asset_class": row.get("assetClass", None),
                        "type": row.get("type", None),
                        "listing_exchange": row.get("listingExchange", None),
                        "country_code": row.get("countryCode", None),
                        "name": row.get("name", None),
                        "group": row.get("group", None),
                        "sector": row.get("sector", None),
                        "sector_group": row.get("sectorGroup", None),
                        "ticker": row.get("ticker", None),
                        "full_name": row.get("fullName", None),
                        "is_us": row.get("isUS", None),
                    },
                )
            except Exception as error:
