...
# Try to import build configuration (generated by CI/CD)
from stonks_overwatch.build_config import *  # noqa: F403
...
MIDDLEWARE = [
    ...
    "stonks_overwatch.middleware.license.LicenseMiddleware",
