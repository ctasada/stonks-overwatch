...
def format_date_time_from_date():
    ...
    assert (
        LocalizationUtility.format_date_time_from_date(datetime.fromisoformat("2020-01-01 10:10:30"))
        == "2020-01-01 10:10:30"
    )
    assert (
        LocalizationUtility.format_date_time_from_date(datetime.fromisoformat("2020-01-01T10:10:30Z"))
        == "2020-01-01 10:10:30"
    )
